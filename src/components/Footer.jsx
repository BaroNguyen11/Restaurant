...
const quick_link = [
  ...
  { label: 'Order', path: '/Order/Order_food' },
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 mb-8">
                                <div className="bg-white/10 p-2 rounded-full backdrop-blur-sm">
                                    <img src="https://jdtxfefnikvizdpsyjni.supabase.co/storage/v1/object/public/image/logo.png" alt="TasteNest" className="w-24 brightness-200 contrast-200" />
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-2 lg:pl-8">
                        ...
                        <ul className="space-y-3">
                            {quick_link.map((item, idx) => (
                                <li key={idx}>
                                    <Link to={item.path} className="flex items-center gap-2 text-gray-600 hover:text-[#9e1c20] transition-colors font-medium group">
                                        ...
                                        <span className="-translate-x-4 group-hover:translate-x-0 transition-transform duration-300">{item.label}</span>
                                    </Link>
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-3">
                            {['Steaks', 'Burgers', 'Cocktails', 'Bar B Q', 'Desserts'].map((item, idx) => (
                                <li key={idx}>
                                    <Link to='/menu' className="flex items-center gap-2 text-gray-600 hover:text-[#9e1c20] transition-colors font-medium group">
                                        <ChevronRight size={16} className="text-[#9e1c20] opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all" />
