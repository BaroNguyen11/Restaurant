    ...
    <div className="w-full bg-white font-['Poppins'] overflow-hidden pt-20">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
                {/* Lá trang trí */}
                <img src="https://static.vecteezy.com/system/resources/previews/027/214/956/non_2x/fresh-basil-leaf-isolated-on-transparent-background-png.png" className="absolute bottom-10 -right-5 w-24 rotate-45 opacity-60" alt="leaf" />
                ...
                <div className="space-y-6 relative z-10">
                    ...
                    <div className="flex items-start gap-4 group">
                        <div className="w-12 h-12 bg-[#F51E46] rounded-full flex items-center justify-center text-white shrink-0 shadow-lg group-hover:scale-110 transition-transform">
                            <MapPin size={20} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-start gap-4 group">
                     ...
                     {/* Hours */}
                     <div className="flex items-start gap-4 group">
                        <div className="w-12 h-12 bg-[#FFA500] rounded-full flex items-center justify-center text-white shrink-0 shadow-lg group-hover:scale-110 transition-transform">
                            <Clock size={20} />
                        </div>
                        <div>
                ...
                <form className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            <input type="text" placeholder="Your Name" className="w-full bg-[#f4f1ea] py-4 pl-6 pr-10 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#9e1c20]" />
                            <User className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                        </div>
                        {/* Email Input */}
                        <div className="relative">
                            <input type="email" placeholder="Your Email" className="w-full bg-[#f4f1ea] py-4 pl-6 pr-10 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#9e1c20]" />
                    ...
                    {/* Subject Select */}
                    <div className="relative">
                         <select className="w-full bg-[#f4f1ea] py-4 pl-6 pr-10 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#9e1c20] text-gray-500 appearance-none cursor-pointer">
                    ...
                    {/* Message Area */}
                    <div className="relative">
                        <textarea rows="5" placeholder="Write Messages..." className="w-full bg-[#f4f1ea] py-4 pl-6 pr-10 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#9e1c20] resize-none"></textarea>
                        <PenTool className="absolute right-4 top-6 text-gray-400" size={18} />
                    </div>

                    {/* Submit Button */}
                    <button type="button" className="bg-black text-white font-bold py-4 px-8 rounded-full shadow-lg hover:bg-[#9e1c20] transition-colors duration-300 flex items-center gap-2 text-sm tracking-widest uppercase">
                        Send Message Now
                    </button>
                </form>
            </motion.div>
                ...
                <div className="lg:col-span-5 bg-[#ffe8d6] p-10 flex flex-col justify-center items-center text-center relative overflow-hidden">
                    ...
                    <div className="flex gap-4 mt-8 relative z-10">
                        {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                            <a key={i} href="#" className="w-10 h-10 border border-gray-400 rounded-full flex items-center justify-center text-gray-600 hover:bg-[#F51E46] hover:text-white hover:border-[#F51E46] transition-all duration-300">
                                <Icon size={16} />
                            </a>
                        ))}
                    </div>
