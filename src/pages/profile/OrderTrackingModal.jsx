...
// import { Package, Truck, CheckCircle, Clock, MapPin, X, XCircle, CreditCard, FileText } from 'lucide-react';

// const OrderTrackingModal = ({ order, onClose }) => {
//     if (!order) return null;

//     // 1. Kiểm tra xem có phải là COD không
//     const isCOD = order.payment_method?.toLowerCase() === 'cod';

//     // 2. Định nghĩa các bước động dựa trên phương thức thanh toán
//     const STEPS = [
//         { 
//             id: 'placed', 
//             label: 'Order Placed', 
...
//             description: isCOD ? 'Seller is preparing your order' : 'Seller has received payment', 
//             icon: isCOD ? <FileText size={18} /> : <CheckCircle size={18} /> 
//         },
//         { 
//             id: 'shipped', 
//             label: 'Shipping', 
//             description: 'Handed over to logistics provider', 
//             icon: <Truck size={18} /> 
//         },
//         { 
//             id: 'delivered', 
//             label: 'Delivered', 
//             description: 'Package received successfully', 
//             icon: <Package size={18} /> 
//         },
//     ];

//     // 3. Logic xác định bước hiện tại
...
//     } else {
//         if (order.status === 'pending') currentStepIndex = 0; 
//         // Nếu có status 'confirmed' thì thêm logic vào đây
//     }
...
//                                     Status: <span className={`font-bold ${order.status === 'paid' ? 'text-green-600' : 'text-orange-500'}`}>{order.status.toUpperCase()}</span>
//                                 </p>
//                             </div>
//                         </div>
//                     </div>
...
//                                         <div className={`absolute -left-5.25 top-0 w-10 h-10 rounded-full flex items-center justify-center border-4 transition-all duration-300 z-10 ${
//                                             isCompleted 
